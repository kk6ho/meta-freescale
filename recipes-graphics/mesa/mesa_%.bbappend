...
SRC_URI:append_use-mainline-bsp = " \
...
PACKAGECONFIG:remove_imxgpu_use-nxp-bsp = "dri"

# mainline/etnaviv:
RRECOMMENDS:${PN}-megadriver:append_use-mainline-bsp = " libdrm-etnaviv mesa-etnaviv-env"
